...
\usepackage{fancyhdr}
\pagestyle{fancy}
\chead{Using Quasistatic Magnetic Fields and Metamaterial Amplifiers for Ubiquitous Wireless Charging}
...
\begin{tikzpicture}
 ...
 \draw[->, thick, black](8, 14.65) -- (14.9, 14.65);
 \draw[->, thick, black](7.4, 14.65) -- (0.4, 14.65);
 \draw[->, thick, black](0.55, 7.85) -- (0.55, 0.75);
 \draw[->, thick, black](0.55, 8.25) -- (0.55, 14.45);
 \draw[->, thick, black](14.65, 7.8) -- (14.65, 0.75);
 \draw[->, thick, black](14.65, 8.2) -- (14.65, 14.45);
 \draw(5.95,8) node{$g_2$};
 \draw(7.70,8.75) node{$g_1$};
 \draw(7.70,7.25) node{$g_1$};
 \draw(1.85, 8) node{$e$};
 \draw(13.35, 8) node{$e$};
 \draw(7.65, 2.15) node{$e$};
 \draw(7.65, 13.34) node{$e$};
\end{tikzpicture}
\caption{The Unit cell of the Metamaterial designed for this project.}
\centering
\end{figure}
\noindent
